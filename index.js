...
//         let key = "c710a823dc1b0f19bf90589d3135ce27"
//         let realLocationLongitude = 3.75
//         let realLocationLatitude = 6.5833
//         // const endpoint =`https://api.openweathermap.org/data/2.5/weather?q=London&appid=${key}`
//         const endpoint = `https://api.openweathermap.org/data/2.5/weather?q=${realLocationLongitude}&lon=${realLocationLatitude}&appid=${key}&units=metric`
//         let response = await fetch(endpoint)
//         let jsonResponse = await response.json()
//         // let icon = `http://openweathermap.org/img/wn/${jsonResponse.weather[0].icon}@2x.png`
//         // image.src = icon
